...
private
  ...
  def whips_by_organisation
    whips = Role.with_translations.includes(:current_people).whip.group_by(&:whip_organisation_id).map do |whip_organisation_id, roles|
    ...
    whips.sort_by { |org, _whips| org.sort_order }
  end
end
